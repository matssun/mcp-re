...
//! signed by `mcp-re-client-core` (with a `continuation` binding inside the signed
//! preimage) MUST be accepted by the server-side `mcp_re_core::verify_request_draft02`
...
fn sign_continuation() -> mcp_re_client_core::SignedRequest {
