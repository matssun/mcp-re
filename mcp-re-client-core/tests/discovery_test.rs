...
use mcp_re_client_core::ProvenSupport;
...
fn verified_response() -> mcp_re_core::VerifiedResponse {
...
fn stripped_or_tampered_advert_does_not_change_the_verdict() {
    ...
    let tampered = json!({ "experimental": { "se.syncom/mcp-re": { "versions": ["draft-01"] } } });
