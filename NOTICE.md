...
“MCP” and “Model Context Protocol” are used descriptively to identify protocol compatibility and the extension proposal target. This repository does not claim ownership of MCP names, marks, or official project status.

## License

Unless otherwise stated, all files in this repository are licensed under the Apache License, Version 2.0.
