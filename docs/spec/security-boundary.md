...
| 2026-09-07 | **THM-0076's dependency closure gains THM-0126 and THM-0127.** Its §2 claim prose, its statement and its security consequence are unchanged, and no row moves between sections; what changed is the argument published under that claim | owner ruling of 2026-09-07, recorded in [`verification/reviews/rulings/thm-0076-dependency-closure-2026-09-07.md`](../../verification/reviews/rulings/thm-0076-dependency-closure-2026-09-07.md). THM-0126 owns the step from a genuinely verified reply to a terminal, continuation or refusal outcome; THM-0127 owns the step that makes the deployable actually run the anchor refresher whose dispositions THM-0057 and THM-0120 establish. The edge was PROPOSED and deliberately left untaken in `packets/client-correctness-2026-09-07.md`, because adding a premise to a published root republishes it — this ruling is the event that was waiting for. The resulting `verification/reviews/specification/THM-0076.json` is a dependency-only re-affirmation and says so; `theorem_claim` is byte-identical to the one the 2026-08-31 ruling approved |
