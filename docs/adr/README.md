...
| [ADR-MCPRE-051](https://github.com/matssun/mcp-re/discussions/399) | High-Throughput Serving Architecture — Sharded Async Data Plane, Stateless Streamable-HTTP Inner Plane, Authoritative Replay Tier, Delegated Signing Custody | ✅ Implemented (§1 [amended 2026-08-06](https://github.com/matssun/mcp-re/discussions/399#discussioncomment-17918976): shards × workers replace one single-threaded runtime per core) |
