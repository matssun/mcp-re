...
| registered at 0B | **5 probes, all live**: S01/S02/S03/S05 crate-boundary over `http_profile.verifier_result_separation`, S04 in-crate over `proxy.client_credential_window_sole_producer` (over `proxy.client_credential_window` until 0D-3 split it) | **none**; the first corpus is 0D's §12.2 unit |
