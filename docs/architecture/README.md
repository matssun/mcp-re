...
- [**ADR-MCPRE-068**](assurance-evidence-classes.md) — evidence classes: what kind of thing supports a security claim. 📄 Proposed 2026-09-17. Assurance TCB, not a product claim: the registry can say *theorem → unit* but not *proved / structural / tested / assumed / external / review-obligation*, so no rule can require the evidence kind to be ADEQUATE to what the claim promises. Adds one sort to ADR-MCPRE-059; supersedes nothing. See [`assurance-evidence-classes.md`](assurance-evidence-classes.md).
