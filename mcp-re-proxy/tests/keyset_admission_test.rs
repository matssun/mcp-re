...
//! taxonomy (`mcp-re.actor_binding_failed`) with no new error or `_meta` key.

use mcp_re_core::error::McpReError;
use mcp_re_core::ids::RESPONSE_META_KEY;
use mcp_re_core::pipeline::verify_response;
use mcp_re_core::response_signing_preimage;
use mcp_re_core::SigningKey;
use mcp_re_proxy::trust_cache::system_clock;
use mcp_re_proxy::AuthorizedKeyEntry;
use mcp_re_proxy::AuthorizedKeySet;
use mcp_re_proxy::BoundedTrustCache;
use mcp_re_proxy::KeySetTrustResolver;
use mcp_re_proxy::KeyStatus;
use serde_json::json;
