...
//!      admits a legacy draft-01 request end-to-end (the existing `mcp-re-host`
//!      fleet keeps working untouched);
//!   2. a proxy tightened to [`ExpectedVersionPolicy::Draft02Only`] refuses the
//!      SAME draft-01 request as a downgrade (`mcp-re.downgrade_forbidden`) BEFORE
...
/// A draft-01 signed `tools/call` (mcp-re-host signs draft-01).
