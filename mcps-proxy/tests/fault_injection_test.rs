...
//! mcps-transport's `tests/fault_injection_test.rs`.
//!
...
//! NOT part of the default-config conformance run. The mcps-proxy crate's default
...
fn make_ca() -> Ca {
    ...
    params
        .distinguished_name
        .push(DnType::CommonName, "mcps-fault-ca");
