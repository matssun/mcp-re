...
| R9-C067 | medium | `assurance-platform` | Per-unit registration still whitelists future escape-hatch sites in every file the unit declares | `SURVIVES_AND_MAPPED` | assurance platform | Same as C037. | closed by #835 (`441f1f6bcf35`) |
| R9-C068 | medium | `assurance-platform` | Escape-hatch registration is per mechanism KIND: every declared file already reads 'registered' for external_body | `SURVIVES_AND_MAPPED` | assurance platform | Same as C037. | closed by #835 (`441f1f6bcf35`) |
