...
| conformance.audit_vocabulary_drift | V0 | _none_ | 0 |
| conformance.carrier_minting_absence | V0 | _none_ | 0 |
| conformance.production_half_definition | V0 | _none_ | 0 |
| conformance.retained_corpus | V0 | _none_ | 0 |
| conformance.scanned_tree_declaration | V0 | _none_ | 0 |
...
| http_profile.carrier_verdict_projection | V0 | _none_ | 0 |
...
| proxy.certificate_identity_refusal_vocabulary | V0 | _none_ | 0 |
...
| proxy.channel_peer_resolution | V0 | _none_ | 0 |
...
| proxy.credential_currency_evidence_reporting | V0 | _none_ | 0 |
...
| proxy.currency_policy_classification | V0 | _none_ | 0 |
...
| proxy.transport_binding_application | V0 | _none_ | 0 |
| proxy.trust_cache_entry_addressing | V0 | _none_ | 0 |
...
| proxy.trust_posture_declaration | V0 | _none_ | 0 |
...
| sdk_python.correlation_lifecycle | V0 | _none_ | 0 |
| sdk_python.exchange_binding | V0 | THM-0094 | 0 |
| sdk_python.execution_report | V0 | _none_ | 0 |
| sdk_python.local_failure_provenance | V0 | _none_ | 0 |
| sdk_python.nonce_floor | V0 | _none_ | 0 |
| sdk_python.notification_delivery | V0 | _none_ | 0 |
| sdk_python.reply_envelope | V0 | _none_ | 0 |
