...
//! signed MCP-S request but can never extract the key or forge a signature
...
//! `mcps-core`, signs it, and returns the wire bytes. Response verification is
//! re-exported from `mcps-core` (see the crate root).
