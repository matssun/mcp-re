//! Local client-side MCP-S proxy (MCPS-49, #196) — the first adoption bridge.
//!
//! This is the MODE-SPECIFIC layer above the pure `mcps-client-core` seam: it owns
...
//! client speaks PLAIN MCP and never sees an MCP-S field (ADR-MCPS-044 §Proxy
