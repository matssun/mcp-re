...
//!
//! MCP-RE secures a stateless elicitation flow as two ordinary signed legs plus a
...
//! `mcp-re-client-core`, and the SDK: classifying a verified response's result body,
