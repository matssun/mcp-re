...
pub fn reason_label(error: &McpReError) -> &'static str {
    match error {
        ...
        McpReError::CanonicalizationFailed => "Canonicalization failed",
        ...
        McpReError::CanonicalizationIdMissing => "canonicalization_id missing",
        McpReError::CanonicalizationIdUnknown => "canonicalization_id unknown",
        McpReError::CanonicalizationIdNotAllowed => "canonicalization_id not allowed by profile",
        McpReError::CanonicalizationIdMismatch => "canonicalization_id mismatch",
