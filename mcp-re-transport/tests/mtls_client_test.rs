...
//!
//! These tests stand up the real server side (`mcp_re_proxy::serve_once`) on a
//! thread and drive it with `mcp_re_transport::MtlsClient`. Certificates are
...
// ---------------------------------------------------------------------------
// rcgen CA + leaves (same idiom as mcp-re-proxy/tests/tls_test.rs).
// ---------------------------------------------------------------------------
