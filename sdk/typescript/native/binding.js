...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./mcp-re-sdk-core.wasi.cjs', false, ["./mcp-re-sdk-core.wasm32-wasi.debug.wasm","./mcp-re-sdk-core.wasm32-wasi.wasm"])
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('@mcp-re/sdk-wasm32-wasi', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          const bindingPackageVersion = require('@mcp-re/sdk-wasm32-wasi/package.json').version
...
module.exports.signNotification = nativeBinding.signNotification
module.exports.signNotificationWithSigner = nativeBinding.signNotificationWithSigner
...
module.exports.verifyAccepted202 = nativeBinding.verifyAccepted202
