...
delivered; `onNotificationAcknowledged` observes the ones that verified.
...
If it does not verify, `send()` throws `NotificationNotAcknowledged`. A notification has no
