//! stdio transport for the MCP-RE conformance server (MCPS-012).
//!
...
use crate::server::McpReServer;

/// Serve newline-delimited MCP-RE requests from `input`, writing one
