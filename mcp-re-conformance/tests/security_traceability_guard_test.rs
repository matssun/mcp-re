...
const BUILD_ENVS: &[(&str, &str)] = &[
    ...
    ("//mcp-re-demo-server", "MCP_RE_BUILD_DEMO_SERVER"),
...
fn source_env_for(source: &str) -> &'static str {
    match source {
        ...
        "mcp-re-demo/tests/demo_negative_e2e_test.rs" => "MCP_RE_SRC_DEMO_NEGATIVE_E2E",
        "mcp-re-demo/tests/demo_transport_e2e_test.rs" => "MCP_RE_SRC_DEMO_TRANSPORT_E2E",
        "mcp-re-demo/tests/demo_e2e_persistent_test.rs" => "MCP_RE_SRC_DEMO_E2E_PERSISTENT",
        "mcp-re-demo/tests/demo_posture_e2e_test.rs" => "MCP_RE_SRC_DEMO_POSTURE_E2E",
        "mcp-re-demo-server/tests/received_log_test.rs" => "MCP_RE_SRC_RECEIVED_LOG",
        ...
        "mcp-re-proxy/tests/persistent_scope_test.rs" => "MCP_RE_SRC_PERSISTENT_SCOPE",
        "mcp-re-proxy/tests/persistent_inner_test.rs" => "MCP_RE_SRC_PERSISTENT_INNER",
        "mcp-re-proxy/tests/persistent_session_test.rs" => "MCP_RE_SRC_PERSISTENT_SESSION",
