...
//!
//! Drives the full MCP-S outcome matrix over real loopback HTTP and asserts the
...
//!
//! The stdio comparison launches the `mcps_stdio_server` child process, located
//! from `MCPS_STDIO_SERVER` ($(rlocationpath)) resolved against the runfiles
