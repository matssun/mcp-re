...
//!    ▼
//! mcps_proxy_cli  (SEPARATE OS process spawned here: mTLS terminate + verify,
...
//! matching `mcps-proxy/tests/full_stack_test.rs`.
...
/// Spawn the real `mcps_proxy_cli` as its OWN process with the full P1 flag set
